...
<head>
    ...
    <meta name="description" content="Learn about Impala Ship Supply, a company providing reliable, fast, and solution-oriented maritime services worldwide, offering ship supply, provisions, spare parts, safety equipment, and logistics support." />
    <meta name="keywords" content="Impala Ship Supply, about Impala, maritime services, ship supply, global support, maritime logistics, provisions, spare parts, safety equipment" />
    <meta name="author" content="Impala Ship Supply">
    
    <meta property="og:title" content="Impala | About Us" />
    <meta property="og:description" content="Discover Impala Ship Supply's mission, values, and services. We provide comprehensive maritime solutions including ship supply, provisions, spare parts, safety equipment, and logistics." />
    <meta property="og:url" content="https://www.impalashipsupply.com/about" />
    <meta property="og:type" content="website" />
    <title>Impala | About Us</title>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="thumbnail" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <img src="assets/images/about-us/01.webp" alt="creative_about">
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="about-right-one-area">
                        ...
                        <p class="disc" data-sal-delay="300" data-sal="slide-up" data-sal-duration="800">
                            Rooted in sustainability and customer satisfaction, we aim to be a trusted partner by delivering quality
                            partner.
                            services, competitive prices, and reliable products. As a dependable ally at sea, IMPALA SHIP SUPPLY
                            We continue to offer distinguished services in the sector, with our commitment to understanding the
                            continues to set the standard in maritime support.
                            needs of our customers and meeting them 
                        </p>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="single-working-process-one">
                        <div class="inner text-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                            ...
                            <p class="disc">
                                We analyze your vessel’s needs and create a custom supply plan.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="single-working-process-one">
                        <div class="inner text-center" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                            ...
                            <p class="disc">
                                We find the right products fast.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="single-working-process-one">
                        <div class="inner text-center" data-sal-delay="450" data-sal="slide-up" data-sal-duration="800">
                            ...
                            <p class="disc">
                                You sail smoothly — we make sure.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="title-area text-center">
                    ...
                    <h3 class="title" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">Ready to Start Your Supply Request?</h3>
                    <div class="button-area" data-sal-delay="300" data-sal="slide-up" data-sal-duration="800">
                        <a href="contact" class="rts-btn btn-primary">Contact Us <i class="far fa-chevron-double-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
